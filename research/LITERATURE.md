...
| A7 | Banks et al., *Impacts of the Desiccation of the Aral Sea on the Central Asian Dust Life-Cycle*, **JGR: Atmospheres** 2022 | SNIPPET | Aralkum dry bed added **~7% more dust** over Central Asia in the 2000s–2010s vs. the 1980s–1990s, with south-eastward transport bands from the southern basin. Justifies the "distance to Aral bed" static predictor and the dust-regime error analysis. | n/a |
...
appears in Elsevier environmental titles. The benchmark precedent (B1) is in **ESSD**, and the
...
1. **Resolved.** A2, A4, B2 and A5 are no longer citation-blocked: authors, venue, year and
   ...
   it was recorded as "Kulkarni et al. (?)", when it is actually Tursumbayeva, Muratuly, Baimatova & Karaca.
